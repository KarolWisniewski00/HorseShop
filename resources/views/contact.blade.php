        ...
        <div class="container mx-auto px-4 my-16">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <address class="grid grid-cols-1 xl:grid-cols-2 gap-8">
                    <div class="flex flex-col justify-center align-middle text-center bg-white shadow rounded-xl border text-bone-900 p-2">
                        <i class="text-2xl fa-solid fa-location-dot"></i>
                        <span class="text-bone-500 text-4xl">Znajdź nas</span>
                    ...
                    <div class="flex flex-col justify-center align-middle text-center gap-4">
                        <a href="tel:{{ $setting['number_phone'] }}" class="bg-white shadow rounded-xl border h-full flex flex-col justify-center align-middle text-center text-bone-900 p-2">
                            <i class="text-2xl fa-solid fa-phone"></i>
                            <span class="text-bone-500 text-4xl">Zadzwoń</span>
                            <span class="text-xl">{{ $setting['number_phone'] }}</span>
                        </a>
                        <a href="mailto:{{ $setting['email'] }}" class="bg-white shadow rounded-xl border h-full flex flex-col justify-center align-middle text-center text-bone-900 p-2">
                            <i class="text-2xl fa-solid fa-envelope"></i>
                            <span class="text-bone-500 text-4xl">Napisz</span>
