    ...
    <section class="pt-20">
        ...
        <div class="container mx-auto text-center my-16 relative">
            <div class="mb-4 flex flex-row gap-4 items-center justify-center">
                <a href="{{route('priv.create')}}" class="dark:bg-green-700 dark:hover:bg-green-800 dark:focus:ring-green-500 text-white bg-green-500 hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
                    <i class="fa-solid fa-plus mr-2"></i>Utwórz treść
                </a>
            </div>
            @foreach($elements as $e)
            @if($e->id == $element->id)
            <form action="{{route('priv.update', $element)}}" method="POST" class="w-100 border-2 rounded p-4 dark:border-stone-700">
                @method('PUT')
                @csrf
                <div class="mb-6">
                ...
                <a href="{{ route('priv') }}" class="dark:text-red-700 dark:border-red-800 dark:hover:bg-red-700 dark:focus:ring-red-500 text-red-500 hover:text-white border border-red-600 hover:bg-red-500 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
            ...
            <div class="mb-4 flex flex-row gap-4 items-center justify-center">
                <a href="{{route('priv.edit', $e)}}" class="dark:bg-blue-700 dark:hover:bg-blue-800 dark:focus:ring-blue-500 text-white bg-blue-500 hover:bg-blue-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
