    ...
    <section class="pt-20">
        ...
        <div class="container mx-auto text-center my-16 relative">
            ...
            <div class="mb-4 flex flex-row gap-4 items-center justify-center">
                <a href="{{route('rule.create')}}" class="text-white bg-green-500 hover:bg-green-600 dark:bg-green-700 dark:hover:bg-green-800 dark:focus:ring-green-500 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
            ...
            @if(auth()->check() && auth()->user()->role === 'ADMIN')
            <div class="mb-4 flex flex-row gap-4 items-center justify-center">
                <a href="{{route('rule.edit', $element)}}" class="text-white bg-blue-500 hover:bg-blue-600 dark:bg-blue-700 dark:hover:bg-blue-800 dark:focus:ring-blue-500 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
