<x-guest-layout>
    ...
    <section class="pt-20">
        <div class="container mx-auto text-center my-16 relative">
            <div class="text-5xl font-horse relative mb-4">Regulamin</div>
            ...
            @if($e->id == $element->id)
            <form action="{{route('rule.update', $element)}}" method="POST" class="w-100 border-2 rounded p-4">
                @method('PUT')
                @csrf
                <div class="mb-6">
            ...
            <div class="mb-4 flex flex-row gap-4 items-center justify-center">
                <a href="{{route('rule.edit', $e)}}" class="text-white bg-blue-500 hover:bg-blue-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
