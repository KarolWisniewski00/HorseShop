<x-guest-layout>
    ...
    <section class="pt-20">
        ...
        <div class="container mx-auto text-center my-16 relative">
            <form action="{{route('cookie.store')}}" method="POST" class="w-100 border-2 rounded p-4 dark:border-stone-700">
                @csrf
                <div class="mb-6">
            ...
            <div class="mb-4 flex flex-row gap-4 items-center justify-center">
                <a href="{{route('cookie.edit', $element)}}" class="dark:bg-blue-700 dark:hover:bg-blue-800 dark:focus:ring-blue-500 text-white bg-blue-500 hover:bg-blue-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
