<x-guest-layout>
    ...
    <section class="pt-20">
        <div class="container mx-auto text-center my-16 relative">
            <div class="text-5xl relative font-display font-bold bg-clip-text bg-gradient-to-l from-stone-950 to-stone-500 text-transparent">POLITYKA COOKIES</div>
        </div>
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">{{ Breadcrumbs::render('cookie') }}</span>
                            </div>
                        </li>
                    </ol>
                </nav>
        ...
        <div class="container mx-auto text-center my-16 relative">
            <form action="{{route('cookie.store')}}" method="POST" class="w-100 border-2 rounded p-4">
                @csrf
                <div class="mb-6">
