    ...
    <section class="pt-20">
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-stone-400">{{ Breadcrumbs::render('cookie') }}</span>
                            </div>
                        </li>
                    </ol>
                </nav>
        ...
        <div class="container mx-auto text-center my-16 relative">
            <div class="mb-4 flex flex-row gap-4 items-center justify-center">
                <a href="{{route('cookie.create')}}" class="dark:bg-green-700 dark:hover:bg-green-800 dark:focus:ring-green-500 text-white bg-green-500 hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
                    <i class="fa-solid fa-plus mr-2"></i>Utwórz treść
                </a>
            </div>
            @foreach($elements as $e)
            @if($e->id == $element->id)
            <form action="{{route('cookie.update', $element)}}" method="POST" class="w-100 border-2 rounded p-4 dark:border-stone-700">
                @method('PUT')
                @csrf
                <div class="mb-6">
                ...
                <div class="mb-6">
                    ...
                    <textarea id="content" name="content" rows="4" class="dark:bg-stone-700 dark:text-stone-200 dark:border-stone-600 block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Wpisz treść tutaj">{{ $element->content }}</textarea>
                    @error('content')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                <div class="mb-6">
                    ...
                    <input value="{{ old('order') ? old('order') : $element->order }}" name="order" type="number" class="dark:bg-stone-700 dark:text-stone-200 dark:border-stone-600 shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="0" required>
                    @error('order')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                <button type="submit" class="mr-2 dark:bg-green-700 dark:hover:bg-green-800 dark:focus:ring-green-500 text-white bg-green-500 hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
                    <i class="fa-solid fa-floppy-disk mr-2"></i>Zapisz
                </button>
                <a href="{{ route('cookie') }}" class="dark:text-red-700 dark:border-red-800 dark:hover:bg-red-700 dark:focus:ring-red-500 text-red-500 hover:text-white border border-red-600 hover:bg-red-500 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
            ...
            @switch($e->type)
            @case('title')
            <h1 class="text-4xl dark:text-stone-200">{{$e->content}}</h1>
            <div class="mb-4 flex flex-row gap-4 items-center justify-center">
                <a href="{{route('cookie.edit', $e)}}" class="dark:bg-blue-700 dark:hover:bg-blue-800 dark:focus:ring-blue-500 text-white bg-blue-500 hover:bg-blue-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
            ...
            @case('subtitle')
            <h3 class="text-2xl dark:text-stone-200">{{$e->content}}</h3>
            <div class="mb-4 flex flex-row gap-4 items-center justify-center">
                <a href="{{route('cookie.edit', $e)}}" class="dark:bg-blue-700 dark:hover:bg-blue-800 dark:focus:ring-blue-500 text-white bg-blue-500 hover:bg-blue-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
                    <i class="fa-solid fa-pen-to-square mr-2"></i>Edytuj treść
                </a>
            ...
            @default
            <p class="text-lg dark:text-stone-200">{{$e->content}}</p>
            <div class="mb-4 flex flex-row gap-4 items-center justify-center">
                <a href="{{route('cookie.edit', $e)}}" class="dark:bg-blue-700 dark:hover:bg-blue-800 dark:focus:ring-blue-500 text-white bg-blue-500 hover:bg-blue-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
                    <i class="fa-solid fa-pen-to-square mr-2"></i>Edytuj treść
                </a>
