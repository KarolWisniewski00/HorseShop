<x-guest-layout>
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="mt-4">
                <a href="{{ route('login.google') }}" class="w-full text-white bg-[#4285F4] focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium hover:bg-gray-50 shadow hover:text-[#4285F4] rounded-xl text-sm px-5 py-2.5 text-center inline-flex justify-center dark:focus:ring-[#4285F4]/55">
