<x-guest-layout>
    ...
    <section class="pt-20">
        <div class="container mx-auto text-center my-16 relative">
            ...
            <div class="text-5xl relative font-display font-bold bg-clip-text bg-gradient-to-l from-stone-950 to-stone-500 text-transparent">PODSUMOWAIE ZAMÓWIENIA</div>
        </div>
                ...
                <div class="w-full">
                    ...
                    <dl class=" text-gray-900 divide-y divide-gray-200 w-full">
                        ...
                        <div class="flex flex-col pt-3">
                            ...
                            <dd class="text-lg font-semibold">{{$order->hosting}}</dd>
                        </div>
                    </dl>
                </div>
            </div>
