<x-guest-layout>
    ...
    <section class="pt-20">
        <div class="container mx-auto text-center my-16 relative">
            <svg class="fill-stone-200 dark:fill-stone-700 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2" width="110" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 100 100" x="0px" y="0px">
                <defs>
                    <style>
                        .cls-1 {
                            fill-rule: evenodd;
            ...
            <div class="text-5xl relative font-display font-bold bg-clip-text bg-gradient-to-l from-stone-950 to-stone-500  dark:from-stone-50 dark:to-stone-50 text-transparent">PODSUMOWAIE ZAMÓWIENIA</div>
        </div>
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="{{route('history')}}" class="ml-1 text-sm font-medium text-gray-700 hover:text-bone-600 md:ml-2 dark:text-stone-400 dark:hover:text-white">{{ Breadcrumbs::render('history') }}</a>
                            </div>
                        </li>
                        @endauth
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-stone-400">{{ Breadcrumbs::render('order') }}</span>
                            </div>
                        </li>
                    </ol>
                </nav>
        ...
        <div class="mx-auto container px-4">
            ...
            <div class="grid grid-cols-1 p-6 bg-white rounded-xl border relative overflow-hidden shadow dark:border-stone-600 dark:bg-stone-700">
                <div class="w-full">
                    <div class="flex flex-row justify-between">
                        <h1 class="mt-8 mb-4 text-2xl font-medium text-gray-900 dark:text-stone-50">
                            Zamówienie
                        </h1>
                    </div>
                    <dl class=" text-gray-900 divide-y divide-gray-200 w-full">
                        ...
                        <div class="flex flex-col py-3">
                            ...
                            <dd class="text-lg font-semibold dark:text-stone-50">{{$order->number}}</dd>
                        </div>
                        <div class="flex flex-col pt-3">
                            <dt class="mb-1 text-gray-500 md:text-lg dark:text-bone-600">Data</dt>
                            <dd class="text-lg font-semibold dark:text-stone-50">{{$order->created_at}}</dd>
                        </div>
                        <div class="flex flex-col pt-3">
                            <dt class="mb-1 text-gray-500 md:text-lg dark:text-bone-600">Łącznie</dt>
                            <dd class="text-lg font-semibold dark:text-stone-50">{{$order->total}} PLN</dd>
                        </div>
                        <div class="flex flex-col pt-3">
                            <dt class="mb-1 text-gray-500 md:text-lg dark:text-bone-600">Metoda płatności</dt>
                            <dd class="text-lg font-semibold dark:text-stone-50">{{$order->payment_type}}</dd>
                        </div>
                    </dl>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 {{$order->payment_type == 'Przelew' ? 'md:grid-cols-2' : ''}} gap-6 py-6">
                <div class="p-6 bg-white rounded-xl border relative overflow-hidden shadow dark:border-stone-600 dark:bg-stone-700">
                    <div class="flex flex-row justify-between">
                        <h1 class="mt-8 mb-4 text-2xl font-medium text-gray-900 dark:text-stone-50">
                            Dane klienta
                        </h1>
                    ...
                    <dl class="max-w-md text-gray-900 divide-y divide-gray-200">
                        @if($order->name != null)
                        <div class="flex flex-col pb-3">
                            <dt class="mb-1 text-gray-500 md:text-lg dark:text-bone-600">Imię i nazwisko</dt>
                            <dd class="text-lg font-semibold dark:text-stone-50">{{$order->name}}</dd>
                        </div>
                        @endif
                        @if($order->email != null)
                        <div class="flex flex-col py-3">
                            <dt class="mb-1 text-gray-500 md:text-lg dark:text-bone-600">Email</dt>
                            <dd class="text-lg font-semibold dark:text-stone-50">{{$order->email}}</dd>
                        </div>
                        @endif
                        @if($order->phone != null)
                        <div class="flex flex-col pt-3">
                            <dt class="mb-1 text-gray-500 md:text-lg dark:text-bone-600">Numer telefonu</dt>
                            <dd class="text-lg font-semibold dark:text-stone-50">{{$order->phone}}</dd>
                        </div>
                        @endif
                        @if($order->company != null)
                        <div class="flex flex-col pt-3">
                            <dt class="mb-1 text-gray-500 md:text-lg dark:text-bone-600">Nazwa firmy</dt>
                            <dd class="text-lg font-semibold dark:text-stone-50">{{$order->company}}</dd>
                        </div>
                        @endif
                        @if($order->nip != null)
                        <div class="flex flex-col pt-3">
                            <dt class="mb-1 text-gray-500 md:text-lg dark:text-bone-600">NIP</dt>
                            <dd class="text-lg font-semibold dark:text-stone-50">{{$order->nip}}</dd>
                        </div>
                        @endif
                        @if($order->adres != null)
                        <div class="flex flex-col pt-3">
                            <dt class="mb-1 text-gray-500 md:text-lg dark:text-bone-600">Adres</dt>
                            <dd class="text-lg font-semibold dark:text-stone-50">{{$order->adres}}</dd>
                        </div>
                        @endif
                        @if($order->adres_extra != null)
                        <div class="flex flex-col pt-3">
                            <dt class="mb-1 text-gray-500 md:text-lg dark:text-bone-600">Ciąg dalszy adresu</dt>
                            <dd class="text-lg font-semibold dark:text-stone-50">{{$order->adres_extra}}</dd>
                        </div>
                        @endif
                        @if($order->city != null)
                        <div class="flex flex-col pt-3">
                            <dt class="mb-1 text-gray-500 md:text-lg dark:text-bone-600">Miasto</dt>
                            <dd class="text-lg font-semibold dark:text-stone-50">{{$order->city}}</dd>
                        </div>
                        @endif
                        @if($order->post != null)
                        <div class="flex flex-col pt-3">
                            <dt class="mb-1 text-gray-500 md:text-lg dark:text-bone-600">Kod pocztowy</dt>
                            <dd class="text-lg font-semibold dark:text-stone-50">{{$order->post}}</dd>
                        </div>
                        @endif
                        @if($order->extra != null)
                        <div class="flex flex-col pt-3">
                            <dt class="mb-1 text-gray-500 md:text-lg dark:text-bone-600">Uwagi dotyczące zamówienia</dt>
                            <dd class="text-lg font-semibold dark:text-stone-50">{{$order->extra}}</dd>
                        </div>
                        @endif
                    </dl>
                </div>
                ...
                <div class="p-6 bg-white rounded-xl border relative overflow-hidden shadow dark:border-stone-600 dark:bg-stone-700">
                    ...
                    <dl class="max-w-md text-gray-900 divide-y divide-gray-200">
                        <div class="flex flex-col pb-3">
                            <dt class="mb-1 text-gray-500 md:text-lg dark:text-bone-600">Pełna nazwa firmy</dt>
                            <dd class="text-lg font-semibold dark:text-stone-50">{{ $setting['name_company'] }}</dd>
                        </div>
                        <div class="flex flex-col py-3">
                            <dt class="mb-1 text-gray-500 md:text-lg dark:text-bone-600">NIP</dt>
                            <dd class="text-lg font-semibold dark:text-stone-50">{{ $setting['nip'] }}</dd>
                        </div>
                        <div class="flex flex-col pt-3">
                            <dt class="mb-1 text-gray-500 md:text-lg dark:text-bone-600">Nazwa banku</dt>
                            <dd class="text-lg font-semibold dark:text-stone-50">{{ $setting['name_bank'] }}</dd>
                        </div>
                        <div class="flex flex-col pt-3">
                            <dt class="mb-1 text-gray-500 md:text-lg dark:text-bone-600">Numer konta bankowego</dt>
                            <dd class="text-lg font-semibold dark:text-stone-50">{{ $setting['number_account_bank'] }}</dd>
                        </div>
                        <div class="flex flex-col pt-3">
                            <dt class="mb-1 text-gray-500 md:text-lg dark:text-bone-600">IBAN</dt>
                            <dd class="text-lg font-semibold dark:text-stone-50">{{ $setting['number_iban'] }}</dd>
                        </div>
                    </dl>
                </div>
                @endif
