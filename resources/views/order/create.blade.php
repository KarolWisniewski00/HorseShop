<x-guest-layout>
    ...
    <section class="pt-20">
        <div class="container mx-auto text-center my-16 relative">
            ...
            <div class="text-5xl relative font-display font-bold bg-clip-text bg-gradient-to-l from-stone-950 to-stone-500 text-transparent">PŁATNOŚCI</div>
        </div>
        ...
        <div class="container mx-auto text-start mt-8">
            <form action="{{route('order.store')}}" method="POST" class="w-full grid grid-cols-1 md:grid-cols-3 px-4 gap-4">
                <div class="bg-white border rounded-xl shadow px-8 col-span-2 py-16">
                    <div class="w-full">
                        <!--TOKEN-->
                        @csrf
                        @auth
                        <div class="mb-6">
                            <label for="name" class="block mb-2 text-sm font-medium text-stone-900 dark:text-white">Imię i nazwisko</label>
                        ...
                        <div class="mb-6">
                            <label for="company" class="block mb-2 text-sm font-medium text-stone-900 dark:text-white">Nazwa firmy (opcjonalne jeśli chcesz fakturę VAT)</label>
                        ...
                        <div class="mb-6">
                            <label for="nip" class="block mb-2 text-sm font-medium text-stone-900 dark:text-white">NIP (opcjonalne jeśli chcesz fakturę VAT)</label>
                        ...
                        <div class="mb-6">
                            <label for="post" class="block mb-2 text-sm font-medium text-stone-900 dark:text-white">Kod pocztowy</label>
                        ...
                        <div class="mb-6">
                            <label for="street" class="block mb-2 text-sm font-medium text-stone-900 dark:text-white">Ulica</label>
                        ...
                        <div class="mb-6">
                            <label for="street_extra" class="block mb-2 text-sm font-medium text-stone-900 dark:text-white">Ciąg dalszy adresu (opcjonalne)</label>
                        ...
                        <div class="mb-6">
                            <label for="city" class="block mb-2 text-sm font-medium text-stone-900 dark:text-white">Miasto</label>
                        ...
                        <div class="mb-6">
                            <label for="phone" class="block mb-2 text-sm font-medium text-stone-900 dark:text-white">Numer telefonu</label>
                        ...
                        <div class="mb-6">
                            <label for="extra" class="block mb-2 text-sm font-medium text-stone-900 dark:text-white">Uwagi dotyczące zamówienia (opcjonalne)</label>
                        ...
                        <div class="flex items-start mb-6">
                            ...
                            <label for="rules" class="ms-2 text-sm font-medium text-stone-900 dark:text-stone-300">Oświadczam, że zapoznałem/am się z treścią strony <a href="{{route('rule')}}">regulamin</a></label>
                        </div>

                        <div class="flex justify-start space-x-4">
                            <button type="submit" class="shadow inline-block py-2 px-6 bg-bone-500 hover:bg-white hover:text-bone-500 w-full text-center my-4 text-white font-bold rounded-xl transition duration-200"><i class="fa-solid fa-credit-card mr-2"></i>Zamów i zapłać</button>
                ...
                <div class="bg-white border rounded-xl shadow px-8 col-span-1 py-16 h-fit">
                    <div class="mb-2 flex justify-between">
                        <p class="text-stone-700">Koszyk</p>
                        <p class="text-stone-700"> PLN</p>
                    </div>
                    ...
                    <hr class="my-4" />
                    <h3 class="mb-5 text-lg font-medium text-stone-900 dark:text-white">Sposób płatności</h3>
                    <ul class="grid w-full gap-6 md:grid-cols-1">
                        <li>
                            <input type="radio" id="hosting-small" {{ old('hosting-small') ? 'checked' : ''}} name="hosting" value="hosting-small" class="hidden peer" required>
                            <label for="hosting-small" class="inline-flex items-center justify-between w-full p-5 text-stone-500 bg-white border border-stone-200 rounded-lg cursor-pointer dark:hover:text-stone-300 dark:border-stone-700 dark:peer-checked:text-bone-500 peer-checked:border-bone-600 peer-checked:text-bone-600 hover:text-stone-600 hover:bg-stone-100 dark:text-stone-400 dark:bg-stone-800 dark:hover:bg-stone-700">
                                <div class="block">
                        ...
                        <li>
                            <input type="radio" id="hosting-big" {{ old('hosting-big') ? 'checked' : 'checked'}} name="hosting" value="hosting-big" class="hidden peer">
                            <label for="hosting-big" class="inline-flex items-center justify-between w-full p-5 text-stone-500 bg-white border border-stone-200 rounded-lg cursor-pointer dark:hover:text-stone-300 dark:border-stone-700 dark:peer-checked:text-bone-500 peer-checked:border-bone-600 peer-checked:text-bone-600 hover:text-stone-600 hover:bg-stone-100 dark:text-stone-400 dark:bg-stone-800 dark:hover:bg-stone-700">
                                <div class="block">
                        ...
                        <li>
                            <input type="radio" id="hosting-cash" {{ old('hosting-cash') ? 'checked' : ''}} name="hosting" value="hosting-cash" class="hidden peer">
                            <label for="hosting-cash" class="inline-flex items-center justify-between w-full p-5 text-stone-500 bg-white border border-stone-200 rounded-lg cursor-pointer dark:hover:text-stone-300 dark:border-stone-700 dark:peer-checked:text-bone-500 peer-checked:border-bone-600 peer-checked:text-bone-600 hover:text-stone-600 hover:bg-stone-100 dark:text-stone-400 dark:bg-stone-800 dark:hover:bg-stone-700">
                                <div class="block">
                        ...
                        <li>
                            <input type="radio" id="hosting-none"{{ old('hosting-none') ? 'checked' : ''}} name="hosting" value="hosting-none" class="hidden peer">
                            <label for="hosting-none" class="inline-flex items-center justify-between w-full p-5 text-stone-500 bg-white border border-stone-200 rounded-lg cursor-pointer dark:hover:text-stone-300 dark:border-stone-700 dark:peer-checked:text-bone-500 peer-checked:border-bone-600 peer-checked:text-bone-600 hover:text-stone-600 hover:bg-stone-100 dark:text-stone-400 dark:bg-stone-800 dark:hover:bg-stone-700">
                                <div class="block">
                                    <div class="w-full text-lg font-semibold">Odbiór osobisty</div>
                                    <div class="w-full">Brak opłat za przesyłkę</div>
                                </div>
                                <svg class="w-5 h-5 ms-3 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9" />
                                </svg>
