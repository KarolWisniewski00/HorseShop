<x-guest-layout>
    ...
    <div class="pt-20">
        <div class="container mx-auto text-center my-16 relative">
            <div class="text-5xl font-horse relative">Konto</div>
        </div>
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">{{ Breadcrumbs::render('account') }}</span>
                        </div>
                    </li>
                </ol>
            </nav>
        ...
        <div class="mx-auto container">
            <a href="{{route('dashboard')}}" class="duration-200 block shadow text-bone-50 m-1 px-4 py-2 leading-loose text-center font-semibold bg-bone-600 hover:bg-gray-50 hover:text-bone-600 rounded-xl w-fit">Panel Admina</a>
