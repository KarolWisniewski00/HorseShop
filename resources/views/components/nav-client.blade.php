...
<section class="fixed top-0 left-0 right-0 z-10 bg-white shadow dark:bg-stone-700">
    <nav class="relative px-4 py-4 flex justify-between items-center bg-transparent container mx-auto">
        ...
        @endauth
        <a class="shadow hidden lg:inline-block py-2 px-6 bg-bone-500 hover:bg-white hover:text-bone-500 text-sm text-white font-bold rounded-xl transition duration-200 dark:bg-bone-600 dark:text-bone-50 dark:hover:bg-stone-800 dark:hover:text-bone-600" href="{{route('busket')}}"><i class="fa-solid fa-basket-shopping mr-2"></i>Koszyk</a>
    </nav>
    <div class="navbar-menu relative z-50 hidden">
        <div class="navbar-backdrop fixed inset-0 bg-stone-800 opacity-25"></div>
        <nav class="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-stone-50 border-r overflow-y-auto dark:bg-stone-700 dark:border-stone-600">
