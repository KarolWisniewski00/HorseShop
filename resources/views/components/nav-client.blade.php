...
<section class="fixed top-0 left-0 right-0 z-10 bg-white shadow">
    <nav class="relative px-4 py-4 flex justify-between items-center bg-transparent container mx-auto">
        ...
        <ul class="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
            <li><a class="mx-2 text-sm text-bone-600 font-bold" href="{{route('index')}}">Home</a></li>
            <li><a class="mx-2 text-sm text-gray-400 hover:text-gray-500" href="{{route('shop')}}">Sklep</a></li>
            <li><a class="mx-2 text-sm text-gray-400 hover:text-gray-500" href="{{route('about')}}">O nas</a></li>
            <li><a class="mx-2 text-sm text-gray-400 hover:text-gray-500" href="{{route('contact')}}">Kontakt</a></li>
        </ul>
