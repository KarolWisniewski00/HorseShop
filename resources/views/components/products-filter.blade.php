        ...
        <div class="w-full lg:w-1/3 my-16 bg-white shadow rounded-xl pb-4 h-fit">
            <form method="POST" action="{{route('shop.store')}}" id="myForm">
                ...
                <div class="mx-auto text-center relative">
                    <div class="text-2xl relative my-8 text-stone-700">Kategorie produktów</div>
                </div>
                ...
                <div class="mx-auto text-center relative">
                    <div class="text-2xl relative my-8 text-stone-700">Cena</div>
                </div>
                <div class="mx-auto flex flex-col items-start px-4 text-start relative pb-3">
                    <label for="steps-range-1" id="min-label" class="block mb-2 text-sm font-medium text-stone-700 dark:text-white">Od @if($r_price_min!=null){{$r_price_min}}@else{{$price_min}}@endif zł</label>
                ...
                <div class="mx-auto flex flex-col items-start px-4 text-start relative pb-3">
                    <label for="steps-range-2" id="max-label" class="block mb-2 text-sm font-medium text-stone-700 dark:text-white">Do @if($r_price_max!=null){{$r_price_max}}@else{{$price_max}}@endif zł</label>
