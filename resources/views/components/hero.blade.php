...
<section class="pt-20 bg-stone-50">
    <div class="container mx-auto flex flex-col items-center px-4 py-16 text-center relative">
        <div class="grid grid-cols-1 md:grid-cols-2 py-6 bg-white rounded-xl relative overflow-hidden shadow">
            ...
            <div class="relative z-1 order-2 md:order-1 flex flex-col justify-center items-start text-start">
                ...
                <div class="flex flex-row my-4 justify-center px-8">
                    <a href="{{route('shop')}}" class="duration-200 block shadow h-full text-bone-50 m-1 px-4 py-2 leading-loose text-2xl text-center font-semibold bg-bone-600 hover:bg-white hover:text-bone-600 rounded-xl"><i class="fa-solid fa-angles-right mr-2"></i>Sprawdź</a>
                    <a href="{{route('about')}}" class="duration-200 block shadow h-full text-bone-600 m-1 px-4 py-2 leading-loose text-2xl text-center font-semibold bg-white hover:bg-bone-600 hover:text-bone-50 rounded-xl ">Zobacz więcej</a>
                </div>
            </div>
        </div>
    </div>
