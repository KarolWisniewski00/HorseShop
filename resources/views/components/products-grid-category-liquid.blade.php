...
<section class="px-4 pb-16">
    <div class="container mx-auto text-center my-16 relative">
        ...
        <div class="text-5xl relative font-display font-bold bg-clip-text bg-gradient-to-l from-stone-950 to-stone-500  dark:from-stone-50 dark:to-stone-50 text-transparent">OLEJKI</div>
    </div>
