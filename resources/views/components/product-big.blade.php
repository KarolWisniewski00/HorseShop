<a href="{{route('product.show',$product)}}" class="w-full product-small h-full flex flex-col justify-between">
    ...
    <div class="overflow-hidden relative bg-white rounded-xl border shadow p-4 -mt-12 mx-4 relative text-center flex flex-col items-center justify-center dark:bg-stone-700 dark:border-stone-600">
