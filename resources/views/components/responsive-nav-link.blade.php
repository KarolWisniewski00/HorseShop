...
$classes = ($active ?? false)
            ? 'block w-full pl-3 pr-4 py-2 border-l-4 border-bone-400 text-left text-base font-medium text-bone-700 bg-bone-50 focus:outline-none focus:text-bone-800 focus:bg-bone-100 focus:border-bone-700 transition duration-150 ease-in-out'
